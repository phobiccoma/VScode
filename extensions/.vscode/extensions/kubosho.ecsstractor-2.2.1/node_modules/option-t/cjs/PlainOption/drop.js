...
exports.unsafeDropForOption = void 0;
var asMut_1 = require("./asMut");
/**
 ...
 */
function unsafeDropForOption(input, mutator) {
    var mutable = asMut_1.asMutOption(input);
    if (mutable.ok) {
        mutator(mutable);
...
exports.unsafeDropForOption = unsafeDropForOption;
