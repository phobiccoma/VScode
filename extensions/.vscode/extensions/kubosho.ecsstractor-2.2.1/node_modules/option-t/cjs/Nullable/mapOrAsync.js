...
exports.mapOrAsyncForNullable = void 0;
...
function check(value) {
    var passed = expect_1.expectNotNull(value, ErrorMessage_2.ERR_MSG_TRANSFORMER_MUST_NOT_RETURN_NO_VAL_FOR_NULLABLE);
    return passed;
}
/**
 ...
 */
function mapOrAsyncForNullable(input, defaultValue, transformer) {
    if (input === null) {
        var nonNullDefault = expect_1.expectNotNull(defaultValue, ErrorMessage_2.ERR_MSG_DEFAULT_VALUE_MUST_NOT_BE_NO_VAL_FOR_NULLABLE);
...
exports.mapOrAsyncForNullable = mapOrAsyncForNullable;
