...
exports.createClassicSome = createClassicSome;
exports.createClassicNone = createClassicNone;
exports.ClassicSomeConstructor = ClassicSomeConstructor;
exports.ClassicNoneConstructor = ClassicNoneConstructor;
exports.ClassicOptionBase = void 0;
 ...
 */
var ClassicOptionBase = function ClassicOptionBase(ok, val) {
  /**
   *  @private
   *  @type   {boolean}
   */
...
exports.ClassicOptionBase = ClassicOptionBase;
ClassicOptionBase.prototype = Object.freeze({
  ...
  map: function map(fn) {
    ...
    var option = createClassicSome(value);
    return option;
  },
  ...
  flatMap: function flatMap(fn) {
    ...
    var isOption = mapped instanceof ClassicOptionBase;
...
function createClassicSome(val) {
  var o = new ClassicOptionBase(true, val);
  return o;
}
/**
 *  @deprecated
...
function createClassicNone() {
  var o = new ClassicOptionBase(false, undefined);
  return o;
}
/**
 *  @deprecated
...
function ClassicSomeConstructor(val) {
...
function ClassicNoneConstructor() {
