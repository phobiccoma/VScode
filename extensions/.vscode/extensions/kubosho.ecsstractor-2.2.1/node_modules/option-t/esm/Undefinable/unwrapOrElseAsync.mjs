...
function check(value) {
  var passed = expectNotUndefined(value, ERR_MSG_RECOVERER_MUST_NOT_RETURN_NO_VAL_FOR_UNDEFINABLE);
  return passed;
}
/**
...
export function unwrapOrElseAsyncFromUndefinable(input, recoverer) {
