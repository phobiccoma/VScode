...
class JSXScanner extends text_scanner_1.TextScanner {
    ...
    async scanSelector() {
        ...
        if (this.peekLeftChar() === '.') {
            ...
            if (attributeName === 'class') {
                ...
                return simple_selector_1.SimpleSelector.create(raw, wordLeftOffset);
            }
    ...
    async scanCSSModule(attributeValue, wordLeftOffset) {
        ...
        if (modulePath) {
            ...
            if (await fs.pathExists(fullPath)) {
                return simple_selector_1.SimpleSelector.create('.' + attributeValue, wordLeftOffset, vscode_uri_1.URI.file(fullPath).toString());
            }
        }
        return simple_selector_1.SimpleSelector.create('.' + attributeValue, wordLeftOffset);
    }
    /** Parse `import ...`. */
